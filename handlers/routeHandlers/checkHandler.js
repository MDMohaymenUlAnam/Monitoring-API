...
handler.cheeckHandler = (requestProperties, callback) => {
...
handler._check.post = (requestProperties, callback) => {
    ...
    let timeoutSeconds = typeof(requestProperties.body.timeoutSeconds) === 'number' && requestProperties.body.
    timeoutSeconds % 1 === 0 && requestProperties.body.timeoutSeconds >= 1 &&
    ...
    if(protocol && url && method && successCodes && timeoutSeconds){
        ...
        callback(400, {
            error : 'you have a problem in the request',
        });
    }
};
